...
<span class='material-icons' role='button' tabindex='0' on="tap: AMP.setState({selectedDirection: 'left-to-right', selectedLanguage: selectedLanguage || 'en'})">format_textdirection_l_to_r</span>
<span class='material-icons' role='button' tabindex='0' on="tap: AMP.setState({selectedDirection: 'right-to-left', selectedLanguage: selectedLanguage || 'en'})">format_textdirection_r_to_l</span>
</div>
